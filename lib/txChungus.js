...
module.exports = class txChungus {
    ...
    async handleMessage(message){
        //FIXME: quando for mensagem no canal de recommendations, delegar o handling pra outra função, ou essa aqui fica confusa d+
        ...
        if(bannedWords.filter((w) => message.content.includes(w)).length){
